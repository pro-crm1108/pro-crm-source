...
export const DEFAULT_ROLES: RoleDef[] = [
  ...
  },
  {
    ...
    permissions: {
      ...granted(["objects.view", "objects.edit", "objects.works", "tasks.view", "tasks.create", "tasks.comment", "staff.viewCard"]),
      "tasks.edit": "own",
      "deals.viewCard": "own",
  ...
  },
  {
    ...
    permissions: granted(["finance.view", "objects.view", "tasks.view", "clients.view", "products.view", "products.supply", "products.edit"]),
  },
];
...
/** Права склада, которые «досыпаются» системным ролям, если их там ещё нет */
const STOCK_GRANTS: Record<string, string[]> = {
  "role-manager": ["products.view", "products.supply"],
  "role-buyer": ["products.view", "products.supply", "products.edit"],
};
