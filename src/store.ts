...
const products: Product[] = [
  { id: "p1", name: "Ламинат Quick-Step Impressive", unit: "м²", price: 1890, kind: "товар", purchasePrice: 1240, lastSupplyPrice: 1240, basePrice: 1240, stock: 220 },
  { id: "p2", name: "Керамогранит Kerama Marazzi 60×60", unit: "м²", price: 1450, kind: "товар", purchasePrice: 980, lastSupplyPrice: 980, basePrice: 980, stock: 130 },
  { id: "p3", name: "Краска Tikkurila Euro Power 7 (9 л)", unit: "шт", price: 6400, kind: "товар", purchasePrice: 4700, lastSupplyPrice: 4700, basePrice: 4700, stock: 14 },
  { id: "p4", name: "Смеситель Grohe Eurosmart", unit: "шт", price: 8900, kind: "товар", purchasePrice: 6100, lastSupplyPrice: 6100, basePrice: 6100, stock: 6 },
  { id: "p5", name: "Унитаз-компакт Roca Victoria", unit: "шт", price: 12400, kind: "товар", purchasePrice: 8900, lastSupplyPrice: 8900, basePrice: 8900, stock: 4 },
  { id: "p6", name: "Межкомнатная дверь Profil Doors", unit: "шт", price: 14800, kind: "товар", purchasePrice: 10300, lastSupplyPrice: 10300, basePrice: 10300, stock: 11 },
  { id: "p7", name: "Электрика Schneider (комплект на квартиру)", unit: "компл", price: 21500, kind: "товар", purchasePrice: 15400, lastSupplyPrice: 15400, basePrice: 15400, stock: 3 },
  { id: "p8", name: "Тротуарная плитка «Классико» 60 мм", unit: "шт", price: 95, kind: "товар", purchasePrice: 62, lastSupplyPrice: 62, basePrice: 62, stock: 1200 },
  { id: "p9", name: "Плиточный клей Ceresit CM 14 (25 кг)", unit: "меш", price: 620, kind: "товар", purchasePrice: 430, lastSupplyPrice: 430, basePrice: 430, stock: 40 },
  { id: "p10", name: "Гипсокартон Knauf 12,5 мм", unit: "лист", price: 540, kind: "товар", purchasePrice: 385, lastSupplyPrice: 385, basePrice: 385, stock: 90 },
...
const jobs: Job[] = [
  { id: "w1", title: "Штукатурка стен", objectId: "o1", stage: "work", start: day(-2, 9), deadline: day(2, 18), assigneeId: "u3", comment: "Слой до 30 мм, сетка в санузлах." },
  { id: "w2", title: "Укладка плитки в санузлах", objectId: "o1", stage: "plan", start: day(3, 9), deadline: day(5, 18), assigneeId: "u3", comment: "" },
  { id: "w3", title: "Стяжка пола, 2-й этаж", objectId: "o2", stage: "work", start: day(-3, 9), deadline: day(-1, 18), assigneeId: "u3", comment: "Ждём доступ от УК." },
  { id: "w4", title: "Монтаж перегородок ГКЛ", objectId: "o2", stage: "check", start: day(-2, 9), deadline: day(1, 18), assigneeId: "u3", comment: "Проверить шумоизоляцию." },
  { id: "w5", title: "Электромонтаж, точки 1–40", objectId: "o2", stage: "work", start: day(0, 9), deadline: day(4, 18), assigneeId: "u3", comment: "" },
  { id: "w6", title: "Демонтаж старой отделки", objectId: "o3", stage: "plan", start: day(1, 9), deadline: day(3, 18), assigneeId: "u3", comment: "" },
  { id: "w7", title: "Вывоз строительного мусора", objectId: "o1", stage: "done", start: day(-5, 9), deadline: day(-3, 18), assigneeId: "u4", comment: "" },
  { id: "w8", title: "Гидроизоляция санузлов", objectId: "o1", stage: "check", start: day(-1, 9), deadline: day(0, 18), assigneeId: "u3", comment: "2 слоя, проклейка углов." },
  { id: "w9", title: "Монтаж котельной", objectId: "o4", stage: "plan", start: day(5, 9), deadline: day(7, 18), assigneeId: "u3", comment: "После выбора котла заказчиком." },
];
...
export const useCRM = create<CRMState>()(
  persist(
    (set, get) => {
      ...
      loginDemo: (userId) => set((s) => {
        /* После облачного режима в списке могут остаться только облачные сотрудники,
           и демо-id (u1…u4) в нём нет → currentUserId не находится → падает me.role.
           Догружаем недостающих демо-пользователей, чтобы вход в демо никогда не ломался. */
        const missing = users.filter((u) => !s.users.some((x) => x.id === u.id));
        return {
          loggedIn: true, currentUserId: userId, mode: "demo", cloudState: "idle", cloudUser: null,
          modal: [], users: missing.length ? [...s.users, ...missing] : s.users,
        };
      }),
        ...
        switch (table) {
          ...
          case "settings": {
            ...
            set((s) => ({
              ...
              expenseCats: r.expenseCats?.length ? r.expenseCats : s.expenseCats,
