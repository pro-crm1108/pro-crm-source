...
export default function App() {
  ...
  const Page = { home: Home, sales: Sales, clients: Clients, objects: Objects, jobs: Jobs, tasks: Tasks, products: Warehouse, finance: Finance, settings: Settings, archive: Archive }[page];
